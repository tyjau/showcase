...
// 404 global (→ out/404.html). Vit HORS de app/[lang]/layout.tsx (pas de header/footer/dictionnaire
// ni de `lang` dans l'URL), donc page autonome : on importe les styles, on détecte la langue côté
// client (comme le gateway out/index.html) et on préfixe les liens vers la bonne locale. Les <Link>
// Next sont préfixés automatiquement par le basePath (/showcase en déploiement).
import "./globals.css";
